                    ...
                    <div className="signup-form">
                        <form onSubmit={this.handleSubmit} noValidate>
                            <div className="field-container">
                                ...
                                <div className="error-msg">{this.state.errors.name !== undefined ? this.state.errors.name : "Please enter your name"}</div>
                            </div>
                            <div className="field-container">
                                ...
                                <div className="error-msg">{this.state.errors.email !== undefined ? this.state.errors.email : "Please enter your email-ID."}</div>
                            </div>
                            <div className="field-container">
                                ...
                                <div className="error-msg">{this.state.errors.password !== undefined ? this.state.errors.password : "Please enter a password"}</div>
                            </div>
                            <div className="terms-checkbox">
                                <label htmlFor="subscribe" className="checkbox-label">
                                    ...
                                    <div className="error-msg">{this.state.errors.checkbox !== undefined ? this.state.errors.checkbox : "Please check Terms & Policy"}</div>
                                </label>
                            </div>
